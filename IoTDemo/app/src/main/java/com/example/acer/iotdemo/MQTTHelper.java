...
public class MQTTHelper {
    ...
    final String arrayTopics[] = {"Bach14637/feeds/+"};


    final String username = "Bach14637";
    final String password = "aio_YRxZ92529UzdODuJzTKXcelNe6In";
